...
import { AgentTestPage } from './components/AgentTestPage';
...
The plan should be practical, detailed, and actionable for a developer to follow. Do not attempt to fetch additional information about this issue as all available details have been provided above.`;
  ...
  return (
    <div className="min-h-screen bg-gray-800">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-gray-200 rounded-md hover:bg-gray-700 transition-colors px-3 py-2 text-sm"
      ...
      {/* Agent Test Page */}
      {showAgentTest && (
        <AgentTestPage onClose={() => setShowAgentTest(false)} />
      )}
